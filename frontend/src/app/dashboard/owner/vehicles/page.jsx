...
export default function VehiclesPage() {
  ...
  const saveVehicle = async () => {
    console.log("Save clicked", vehicleData); // ✅ Debug
    try {
      const token = localStorage.getItem("token");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
              ...
              <tr>
                ...
                >
                  <div className="flex items-center">
                    Plate Number <FaSort className="ml-1 text-gray-400" />
                  </div>
                </th>
                <th
                ...
                >
                  <div className="flex items-center">
                    Model <FaSort className="ml-1 text-gray-400" />
                  </div>
                </th>
                <th
                ...
                >
                  <div className="flex items-center">
                    Brand <FaSort className="ml-1 text-gray-400" />
                  </div>
                </th>
                <th
                ...
                >
                  <div className="flex items-center">
                    Year <FaSort className="ml-1 text-gray-400" />
                  </div>
                </th>
      ...
      {/* Vehicle Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-[99999] pointer-events-auto">
