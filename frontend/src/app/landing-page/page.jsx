...
export default function LandingPage() {
  ...
  return (
    <div className="w-full bg-white text-gray-900 overflow-x-hidden">
      ...
      {/* ================= Clean Modern Navbar ================= */}
      {user ? <NavbarAfterLogin user={user} /> : <Navbar />}
      {/* <Navbar/> */}
        ...
        <div className="relative z-10 container mx-auto px-6 lg:w-1/2">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              className="group flex items-center justify-center px-8 py-4 bg-blue-600 text-white font-semibold rounded-xl shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all transform hover:scale-105">
          ...
          <div className={`transition-all duration-1000 ${fadeInUp('cta')}`} id="cta">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <button
                    ...
                    className="px-12 py-4 bg-white text-blue-600 font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center"
                  >
