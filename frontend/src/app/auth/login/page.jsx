        ...
        <div className="bg-white/90 backdrop-blur-sm p-10 rounded-3xl shadow-lg w-full max-w-md text-center mt-20">
          ...
          <div className="mt-6 text-gray-600 text-sm space-y-2">
            ...
            <p>
              ...
              <Link href="/auth/forgot-password" className="text-blue-500 hover:underline">Reset</Link>
            </p>
          </div>
        </div>
      </div>
...
//         data.user.username ||
//         "Unknown",
//       id: data.user.id,             // ✅ store userId
//       customerId: data.user.customerId || null, // ✅ store customerId
//       roleId: data.user.roleId || null,
//     };
...
//   //       if (data.token) localStorage.setItem("token", data.token);
//   //         if (data.user) {
//   //           // Standardize user object so `name` always exists
//   //           const userData = {
//   //             ...data.user,
//   //             name:
//   //               data.user.name ||
...
//   //       setModalMessage(
//   //         data.message || "You have been blocked. Please contact support."
//   //       );
//   //       setShowModal(true);
//   //     } else {
...
//   return (
//     <div className="min-h-screen flex flex-col bg-blue-50">
//       {/* ✅ Navbar (but no profile on this page) */}
//       <Navbar />
