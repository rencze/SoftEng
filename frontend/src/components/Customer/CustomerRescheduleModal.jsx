...
function CustomerRescheduleModal({ isOpen, onClose, bookingId, onRescheduleSuccess }) {
...
export default CustomerRescheduleModal;
// function CustomerRescheduleModal({ isOpen, onClose, bookingId }) {
//   const { user, loading } = useAuth();
//   const router = useRouter();
