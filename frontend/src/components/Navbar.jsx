...
import { 
  ChevronDown, Phone, Menu, X, User, UserPlus, 
  LogOut, Settings, Calendar, FileText 
} from 'lucide-react';
            ...
            <nav className="flex flex-col space-y-2">
              ...
              {!currentUser && (
                <>
                  ...
                  <Link href="/auth/login">
                    <button className="px-4 py-3 text-blue-600 font-medium hover:bg-blue-50 rounded-lg transition-colors">
                      Login
                    </button>
                  </Link>
                  <Link href="/auth/register">
                    <button className="px-4 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">
                      Register
                    </button>
                  </Link>
                </>
              ...
              {/* Mobile profile options if logged in */}
              {currentUser && (
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <Link 
                    href="/profile" 
                    className="px-4 py-3 text-gray-700 hover:bg-blue-50 rounded-lg transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Profile
                  </Link>
