...
export default function ServiceJobForm({ onSave, initialData = null, technicians = [], onCancel }) {
  ...
  const completedSteps = serviceJob.jobFlow.filter(step => step.completed).length;
  const totalSteps = serviceJob.jobFlow.length;
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-2">
              {initialData ? "Edit Service Job" : "Create Service Job"}
            </h1>
            <p className="text-gray-600 flex items-center">
              <FaTools className="mr-2" />
              {initialData ? "Edit existing service job" : "Create a new service job with workflow steps"}
            </p>
          </div>
