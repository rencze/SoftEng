...
//       className={`${
//         isOpen ? "w-72" : "w-16"
//       } h-screen bg-gradient-to-b from-white to-gray-50 shadow-xl transition-all duration-300 overflow-hidden flex flex-col border-r border-gray-200`}
//     >
//       {/* Header */}
//       <div className="px-4 py-6 flex items-center justify-center border-b border-gray-200 bg-white">
//         {isOpen ? (
...
//                     </div>
//                     {isOpen && (
//                       <span className={`transition-transform duration-200 ${colorClasses.text} ${
...
//                     openMenu === link.name && isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
//                   }`}>
//                     <div className="ml-6 mt-2 space-y-1 border-l-2 border-gray-100 pl-4">
//                       {link.subLinks.map((sublink, sidx) => {
//                         const isSubActive = isActiveLink(sublink.path);
//                         return (
//                           <Link
//                             key={sidx}
//                             href={sublink.path}
...
//         {/* Logout */}
//         <button className="w-full flex items-center space-x-3 px-3 py-2 rounded-xl text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors duration-200">
//           <FaSignOutAlt className="text-lg" />
//           {isOpen && <span className="font-medium">Logout</span>}
//         </button>
